var s_tc_cbsicbscnsite=new TagContainer('cbsicbscnsite');
...
om.data.rsids="cnetcbssportscollege-dev,cbsicbsiall";
om.data.rsids_dev="cnetcbssportscollege-dev2,cnetcbsiall-dev";

om.data.author_ids='';
om.data.author_names='';
om.data.blog_id='';
om.data.brand ='cbssports college network';
om.data.channel='';
om.data.content_id='';
...
om.data.prod_id='';
om.data.prod_name='';
om.data.evt_open_regform=false;
om.data.evt_open_orderform=false;
om.data.evt_new_subscription=false;
om.data.evt_new_payment=false;
om.data.evt_new_registration=false;
om.data.sc_open=false;
om.data.sc_view=false;
om.data.sc_products=false;
om.data.auct_catid='';
om.data.auct_catname='';
om.data.auct_id='';
om.data.auct_name='';
om.data.order_num='';
...
om.initTracking = function(s,p) {
  ...
  d.rsids=(typeof(p.rsids)!='undefined')?p.rsids+',cbsicbsiall':d.rsids;
  ...
  d.page_name=(typeof(c.page_name)!='undefined')?c.page_name:d.page_name;
  ...
  d.sport=(typeof(c.sport)!='undefined')?c.sport:d.sport;
  d.school=(typeof(c.school)!='undefined')?c.school:d.school;
  d.schoolcode=(typeof(c.schoolcode)!='undefined')?c.schoolcode:d.schoolcode;
  
  d.store_id=(typeof(c.store_id)!='undefined')?c.store_id:d.store_id;
  d.store_name=(typeof(c.store_name)!='undefined')?c.store_name:d.store_name;
  d.dept_id=(typeof(c.dept_id)!='undefined')?c.dept_id:d.dept_id;
  d.dept_name=(typeof(c.dept_name)!='undefined')?c.dept_name:d.dept_name;
  d.prod_id=(typeof(c.prod_id)!='undefined')?c.prod_id:d.prod_id;
  d.prod_name=(typeof(c.prod_name)!='undefined')?c.prod_name:d.prod_name;
  d.evt_open_regform=(typeof(c.evt_open_regform)!='undefined')?c.evt_open_regform:d.evt_open_regform;
  d.evt_open_orderform=(typeof(c.evt_open_orderform)!='undefined')?c.evt_open_orderform:d.evt_open_orderform;
  d.evt_new_subscription =(typeof(c.evt_new_subscription )!='undefined')?c.evt_new_subscription :d.evt_new_subscription;
  d.evt_new_payment=(typeof(c.evt_new_payment)!='undefined')?c.evt_new_payment:d.evt_new_payment;
  d.evt_new_registration =(typeof(c.evt_new_registration )!='undefined')?c.evt_new_registration :d.evt_new_registration;
  d.sc_open=(typeof(c.sc_open)!='undefined')?c.sc_open:d.sc_open;
  d.sc_view=(typeof(c.sc_view)!='undefined')?c.sc_view:d.sc_view;
  d.sc_products=(typeof(c.sc_products)!='undefined')?c.sc_products:d.sc_products;
  
  d.auct_catid=(typeof(c.auct_catid)!='undefined')?c.auct_catid:d.auct_catid;
  d.auct_catname=(typeof(c.auct_catname)!='undefined')?c.auct_catname:d.auct_catname;
  d.auct_id=(typeof(c.auct_id)!='undefined')?c.auct_id:d.auct_id;
  d.auct_name=(typeof(c.auct_name)!='undefined')?c.auct_name:d.auct_name;
  d.order_num=(typeof(c.order_num)!='undefined')?c.order_num:d.order_num;
  }}

  // set site specific s vars
  if(d.schoolcode){d.school_id=d.sid+'-'+d.schoolcode;d.ssid=d.school_id} // school code
  if(d.school){s.prop66='D=v66';s.eVar66=d.school_id+'|'+d.school;} // schools
  if(d.sport){s.prop65='D=v65';s.eVar65=d.sport;}
  
  if(d.store_id && d.store_name){s.prop58='D=v58';s.eVar58=d.school_id+':'+d.store_id+"|"+d.store_name;}
  if(d.dept_id && d.dept_name){s.prop63='D=v63';s.eVar63=d.school_id+':'+d.dept_id+"|"+d.dept_name;}
  if(d.prod_id && d.prod_name){s.prop64='D=v64';s.eVar64=d.school_id+':'+d.prod_id+"|"+d.prod_name;d.product_id=d.prod_id;}
  if(d.sc_products){d.product_id=d.sc_products;}
  
  if(d.auct_id && d.auct_name){s.prop62='D=v62';s.eVar62=d.school_id+':'+d.auct_id+"|"+d.auct_name;}
  if(d.auct_catid && d.auct_catname){s.prop61='D=v61';s.eVar61=d.school_id+':'+d.auct_catid+"|"+d.auct_catname;}
  
  // set on-page events
  var om_ea=new Array();
  if(d.evt_open_regform){om_ea.push("event8");}
  if(d.evt_new_registration){om_ea.push("event5");}
  if(d.evt_open_orderform){om_ea.push("event14");}
  if(d.evt_new_subscription){om_ea.push("event12");}
  if(d.evt_new_payment && d.order_num){om_ea.push("event13:"+d.order_num);}
  else if(d.evt_new_payment){om_ea.push("event13");}
  if(d.page_type=='store checkout'){om_ea.push("scCheckout");}
  if(d.page_type=='store checkout2'){om_ea.push("event81");}
  if(d.page_type=='store checkout3'){om_ea.push("event82");}
  if(d.page_type=='store checkout4'){om_ea.push("event83");}
  if(d.page_type=='store payment'){om_ea.push("event84");}
  if(d.page_type=='store confirm'){om_ea.push("purchase");}
  if(d.sc_open){om_ea.push("scOpen");}
  if(d.sc_view){om_ea.push("scView");}
  ...
  d.page_name=d.school_id+d.page_name; // page name
  }
  if(d.product_id){ // product id
  var om_pa=new Array();
  id_array=d.product_id.split('|');
  if(typeof(id_array)!='undefined'){
  for(var i=0;i<id_array.length;i++){om_pa.push(';'+d.school_id+':'+id_array[i]);}
  if(om_pa.length){s.products = om_pa.join('|');}
  }}
  if(om_section_0){s.channel=om_section_0;} // first channel definition
  if(d.sections && d.page_type){s.hier1=d.school_id+':'+d.sections+'|'+d.page_type;s.eVar6=d.sections+'|'+d.page_type;}// first hier1 definition
  if(d.page_type){s.eVar10=d.page_type;s.prop10='D=v10';} // page type
  if(d.author_ids){s.list3=d.author_ids.toLowerCase();} // author ids
  ...
  if(d.content_id){s.eVar30=d.school_id+':'+d.content_id;s.prop30='D=v30';} // content id
  ...
  if(d.blog_id||d.blog_name){s.eVar26=d.school_id+':'+d.blog_id+'|'+d.blog_name;s.prop26="D=v26";} // blog ids
  ...
  // common s vars
  if(d.page_name){s.pageName=d.page_name.toLowerCase();}// pageName overwrite
  ...
  if(d.err){s.pageType='errorPage';s.pageName=d.school_id+':'+d.err+':error:'+document.location.pathname+document.location.search;s.channel="error";} // overwrite any variables if error page is detected
...
om.trackNewRegistration = function (p) {
  s.linkTrackVars="events,channel,eVar10,eVar66";
  s.linkTrackEvents="event5";
  omdata.context.evt_new_registration=true;
  s.tl(true, 'o', 'trackNewRegistration', null, p);
  this.clearEvents();
}
om.trackScAdd = function(p) {
  var sid = om.data.school_id;
  s.linkTrackVars="events,channel,products,eVar10,eVar58,eVar63,eVar64,eVar66";
  s.linkTrackEvents="scAdd";
  s.events = "scAdd";
  s.tl(true, 'o', 'trackScAdd', null, p);
  this.clearEvents();
}
om.trackScRemove = function(p,h) {
  var sid = om.data.school_id;
  s.linkTrackVars="events,channel,products,eVar10,eVar58,eVar63,eVar64,eVar66";
  s.linkTrackEvents="scRemove";
  s.products=';'+sid+':'+p.id;
  s.events = "scRemove";
  s.tl(true, 'o', 'trackScRemove', null, h);
  this.clearEvents();
}
om.trackAuctWatchlist = function(h) {
  var sid = om.data.school_id;
  s.linkTrackVars="events,channel,eVar10,eVar61,eVar62";
  s.linkTrackEvents="event85";
  s.events = "event85";
  s.tl(true, 'o', 'trackAuctWatchlist', null, h);
  this.clearEvents();
}
om.trackAuctPlaceBid = function() {
  var sid = om.data.school_id;
  s.linkTrackVars="events,channel,eVar10,eVar61,eVar62";
  s.linkTrackEvents="event86";
  s.events = "event86";
  s.tl(true, 'o', 'trackAuctPlaceBid');
  this.clearEvents();
}
om.trackAuctBuyNow = function(h) {
  var sid = om.data.school_id;
  s.linkTrackVars="events,channel,eVar10,eVar61,eVar62";
  s.linkTrackEvents="event87";
  s.events = "event87";
  s.tl(true, 'o', 'trackAuctBuyNow', null, h);
  this.clearEvents();
}
...
s.linkInternalFilters="javascript:,nrelate.com,cbsi.com,"+document.domain
...
function s_doPlugins(s) {
  ...
  if(s.getQueryParam('siteID')!='' && s.getQueryParam('ttag')=='ul13_link_'){om_camp.push('siteid:'+s.getQueryParam('siteID'))};
...
s.setTagContainer("cbsicbscnsite")
